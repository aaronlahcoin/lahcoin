...
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/8;         // 1000KB  block soft limit
...
static const int64 MAX_MONEY = 1050000000 * COIN; // LahCoin: maximum of N coins (given some randomness), max transaction 10,000,000,000 for now
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > 2 * COIN * (60 * 24 / 1.5) / 250; // LahCoin: Priority cutoff is 2 LahCoin day / 250 bytes.
    }
